...
//BEGIN PACMAN/DIGDUG/JOUST CHALLENGE CODE
    MON("Blinky", S_DEMON,
        LVL(10, 8, -5, 50, -5), (G_UNIQ|G_NOCORPSE|G_NOGEN|1),
        A(ATTK(AT_TUCH, AD_PHYS, 1, 1),
          NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK),
        SIZ(WT_HUMAN, 0, MS_SILENT, MZ_HUMAN),
        MR_COLD|MR_DISINT|MR_SLEEP|MR_POISON|MR_STONE, 0,
        M1_FLY|M1_BREATHLESS|M1_WALLWALK|M1_HUMANOID|M1_UNSOLID,
        M2_NOPOLY|M2_STALK|M2_HOSTILE|M2_PNAME, M3_INFRAVISION|M3_INFRAVISIBLE, CLR_RED),
    MON("Pinky", S_DEMON,
        LVL(10, 8, -5, 50, -5), (G_UNIQ|G_NOCORPSE|G_NOGEN|1),
        A(ATTK(AT_TUCH, AD_PHYS, 1, 1),
          NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK),
        ...
        MR_COLD|MR_DISINT|MR_SLEEP|MR_POISON|MR_STONE, 0,
        M1_FLY|M1_BREATHLESS|M1_WALLWALK|M1_HUMANOID|M1_UNSOLID,
        M2_NOPOLY|M2_UNDEAD|M2_STALK|M2_HOSTILE|M2_PNAME, M3_INFRAVISION|M3_INFRAVISIBLE, CLR_BRIGHT_MAGENTA),
    MON("Inky", S_DEMON,
        LVL(10, 8, -5, 50, -5), (G_UNIQ|G_NOCORPSE|G_NOGEN|1),
        A(ATTK(AT_TUCH, AD_PHYS, 1, 1),
          NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK),
        ...
        MR_COLD|MR_DISINT|MR_SLEEP|MR_POISON|MR_STONE, 0,
        M1_FLY|M1_BREATHLESS|M1_WALLWALK|M1_HUMANOID|M1_UNSOLID,
        M2_NOPOLY|M2_UNDEAD|M2_STALK|M2_HOSTILE|M2_PNAME, M3_INFRAVISION|M3_INFRAVISIBLE, CLR_CYAN),
    MON("Clyde", S_DEMON,
        LVL(10, 8, -5, 50, -5), (G_UNIQ|G_NOCORPSE|G_NOGEN|1),
        A(ATTK(AT_TUCH, AD_PHYS, 1, 1),
          NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK),
        ...
        MR_COLD|MR_DISINT|MR_SLEEP|MR_POISON|MR_STONE, 0,
        M1_FLY|M1_BREATHLESS|M1_WALLWALK|M1_HUMANOID|M1_UNSOLID,
        M2_NOPOLY|M2_UNDEAD|M2_STALK|M2_HOSTILE|M2_PNAME, M3_INFRAVISION|M3_INFRAVISIBLE, CLR_ORANGE),
    MON("Fygar", S_DRAGON,
        LVL(10, 8, -5, 50, -5), (G_UNIQ|G_NOCORPSE|G_NOGEN|1),
        A(ATTK(AT_BREA, AD_FIRE, 1, 1), ATTK(AT_TUCH, AD_PHYS, 1, 1),
          NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK),
        SIZ(WT_DRAGON, 1500, MS_SILENT, MZ_GIGANTIC),
        MR_FIRE|MR_COLD|MR_DISINT|MR_SLEEP|MR_POISON|MR_STONE, 0,
        M1_BREATHLESS|M1_WALLWALK|M1_UNSOLID|M1_FLY|M1_THICK_HIDE|M1_NOHANDS|M1_SEE_INVIS|M1_CARNIVORE,
        M2_NOPOLY|M2_STALK|M2_HOSTILE|M2_STRONG|M2_NASTY|M2_PNAME,
        M3_INFRAVISION|M3_INFRAVISIBLE, CLR_GREEN),
    MON("Pooka", S_PIERCER,
        LVL(10, 8, -5, 50, -5), (G_NOCORPSE|G_NOGEN|1),
        A(ATTK(AT_TUCH, AD_PHYS, 1, 1),
         NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK),
        SIZ(WT_HUMAN, 0, MS_SILENT, MZ_HUMAN),
        MR_COLD|MR_DISINT|MR_SLEEP|MR_POISON|MR_STONE, 0,
        M1_BREATHLESS|M1_WALLWALK|M1_HUMANOID|M1_UNSOLID|M1_NOHANDS,
        M2_NOPOLY|M2_STALK|M2_HOSTILE|M2_PNAME,
        M3_INFRAVISION|M3_INFRAVISIBLE, CLR_ORANGE),
    MON("ostrich", S_ORC,
        LVL(4, 20, 6, 0, 0), (G_NOCORPSE|G_NOGEN|1),
        A(NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK),
        SIZ(1500, 300, MS_SQAWK, MZ_LARGE), 0, 0,
        M1_FLY|M1_ANIMAL|M1_NOHANDS|M1_CARNIVORE,
    ...
    MON("buzzard", S_BLOB,
        ...
        M1_FLY|M1_ANIMAL|M1_NOHANDS|M1_CARNIVORE,
        M2_WANDER|M2_HOSTILE, M3_INFRAVISIBLE, CLR_BLACK),
    MON("the Bounder", S_BAT,
        LVL(12, 12, 10, 40, 10), (G_UNIQ|G_NOCORPSE|G_NOGEN|1),
        A(ATTK(AT_TUCH, AD_PHYS, 1, 1), NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK),
        SIZ(WT_HUMAN, 400, MS_GUARD, MZ_HUMAN), 0, 0,
        M1_HUMANOID|M1_OMNIVORE, M2_NOPOLY|M2_HUMAN|M2_STRONG,
        M3_INFRAVISIBLE, CLR_RED),
    MON("the Hunter", S_GIANT,
        LVL(12, 10, 10, 15, -5), (G_UNIQ|G_NOCORPSE|G_NOGEN|1),
        A(ATTK(AT_TUCH, AD_PHYS, 1, 1), NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK),
        SIZ(WT_HUMAN, 400, MS_GUARD, MZ_HUMAN), 0, 0,
        M1_HUMANOID|M1_OMNIVORE, M2_NOPOLY|M2_HUMAN|M2_STRONG,
        M3_INFRAVISIBLE, CLR_BRIGHT_CYAN),
    MON("the Shadow Lord", S_SNAKE,
        LVL(12, 10, 10, 15, -5), (G_UNIQ|G_NOCORPSE|G_NOGEN|1),
        A(ATTK(AT_TUCH, AD_PHYS, 1, 1), NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK),
        SIZ(WT_HUMAN, 400, MS_GUARD, MZ_HUMAN), 0, 0,
        M1_HUMANOID|M1_OMNIVORE, M2_NOPOLY|M2_HUMAN|M2_STRONG,
