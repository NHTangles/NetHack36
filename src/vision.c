...
//BEGIN PACMAN/DIGDUG/POOL/JOUST CHALLENGE CODE
    if(Is_pmaze_level(&u.uz) || Is_dmaze_level(&u.uz) || Is_pool_level(&u.uz) || Is_joust_level(&u.uz)) {
        return(0);
    }
//END PACMAN/DIGDUG/POOL/JOUST CHALLENGE CODE
